...
public class PartyMember {
    ...
    /**
     * Overloaded constructor for a PartyMember object which takes all stats.
     * @param n The name of the Pokemon
     * @param l The level of the Pokemon
     * @param x The total xp of the Pokemon
     * @param s The leveling speed of the Pokemon
     */
    public PartyMember(String n, int l, int x, String s) {
        name = n;
        level = l;
        xp = x;
        xpspeed = s;
